...
import com.delivery_api.Projeto.Delivery.API.model.*;
...
public class PedidoServiceImpl implements PedidoService {
    ...
    public PedidoResponseDTO criarPedido(PedidoRequestDTO dto) {
        ...
        Cliente cliente = clienteRepository.findById(dto.getClienteId())
                .orElseThrow(() -> new ModelNotFoundException("Cliente não encontrado"));
        ...
        for (ItemPedidoRequestDTO itemDTO : dto.getItens()) {
            Produto produto = produtoRepository.findById(itemDTO.getProdutoId())
                    .orElseThrow(() -> new ModelNotFoundException("Produto não encontrado: " + itemDTO.getProdutoId()));
        ...
        pedido.setNumeroPedido(java.util.UUID.randomUUID().toString());
    ...
    public List<PedidoResponseDTO> listarPedidosPorCliente(Long clienteId) {
        ...
        if (pedidos.isEmpty()) {
            throw new ModelNotFoundException("Nenhum pedido encontrado para o cliente com ID: " + clienteId);
        }
